...
- 新增馋猫0a6稳定语料路线及独立“写稿思路”层；核心是普通人后果、明确立场和具体办法，不靠方言词贴纸。
- 新增酒言酒语久久久近期旅游商业深评 prototype；2018-2020 招聘旧帖不参与当前 DNA。
- 冻结 8 篇 holdout，新增 6 个测试 prompt，并完成 OpenClaw 原生出稿、弱素材回退和两名独立评审。
- 评审后最小修正：馋猫避免治理清单；酒言标题不把过夜率跨推为消费结果，章节不机械对称；补料最多 5 问。
