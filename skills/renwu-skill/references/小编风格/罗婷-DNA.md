...
- 完整互动样本：30
- 置信度：stable
- 主要类型：对话访谈(14)、社会公共事件(8)、文娱影视人物(4)
...
- 段落节奏：段落更完整，叙述链更长；段落中位约 72.75 个中文字符。
...
1. 先读账号总风格和对应类型 DNA。
2. 用户明确指定“按 罗婷 线”时，再叠加本文件。
3. 如果素材类型与 `罗婷` 的强项冲突，以类型 DNA 为主，本文件只调节节奏和观察角度。
4. 不冒充 罗婷 本人，不写“我是/本记者认为”。
