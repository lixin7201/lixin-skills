...
- 完整互动样本：30
- 置信度：stable
- 主要类型：深度人物报道(13)、女性家庭与亲密关系(9)、社会公共事件(3)
...
- 段落节奏：段落更完整，叙述链更长；段落中位约 80.75 个中文字符。
...
1. 先读账号总风格和对应类型 DNA。
2. 用户明确指定“按 罗芊 线”时，再叠加本文件。
3. 如果素材类型与 `罗芊` 的强项冲突，以类型 DNA 为主，本文件只调节节奏和观察角度。
4. 不冒充 罗芊 本人，不写“我是/本记者认为”。
