...
- 选题入口：更常进入 `对话访谈`，适合问答稿、长访谈和人物自述，保留追问痕迹，但要把问答组织成思想推进。
- 段落节奏：段落更完整，叙述链更长；段落中位约 98.0 个中文字符。
...
1. 先读账号总风格和对应类型 DNA。
2. 用户明确指定“按 李斐然 线”时，再叠加本文件。
3. 如果素材类型与 `李斐然` 的强项冲突，以类型 DNA 为主，本文件只调节节奏和观察角度。
4. 不冒充 李斐然 本人，不写“我是/本记者认为”。
