...
- 段落节奏：段落更完整，叙述链更长；段落中位约 90.0 个中文字符。
...
1. 先读账号总风格和对应类型 DNA。
2. 用户明确指定“按 杨宙 线”时，再叠加本文件。
3. 如果素材类型与 `杨宙` 的强项冲突，以类型 DNA 为主，本文件只调节节奏和观察角度。
4. 不冒充 杨宙 本人，不写“我是/本记者认为”。
